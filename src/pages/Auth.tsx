...
const AuthPage = () => {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-[#426f7d]">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_20%_82%,#91c6d4_0%,transparent_42%),radial-gradient(circle_at_90%_14%,#5f8f9d_0%,transparent_36%),linear-gradient(180deg,#3d7180_0%,#79adbc_100%)]" />

      <div className="absolute -left-[30vw] -top-[8vh] h-[124vh] w-[94vw] rounded-[47%] bg-gradient-to-br from-[#6a0602] via-[#470401] to-[#240201] rotate-[26deg] shadow-[inset_0_0_120px_rgba(255,88,0,0.28)]" />
      <div className="absolute -left-[5vw] top-[16vh] h-[20vh] w-[84vw] rounded-[55%] bg-gradient-to-br from-[#cb2f0a] via-[#a41e09] to-[#5d0b04] rotate-[31deg] opacity-95" />
      <div className="absolute left-[28vw] top-[18vh] h-[76vh] w-[67vw] bg-gradient-to-br from-[#ef7249] via-[#d6552d] to-[#922d16] [clip-path:polygon(9%_0%,100%_19%,71%_100%,0%_68%)] shadow-[0_38px_60px_-18px_rgba(55,7,0,0.62)]" />
      ...
      <div className="relative z-10 min-h-screen w-full">
        <div className="absolute inset-0 flex items-center justify-center sm:justify-start px-6 sm:pl-12 sm:pr-[25rem] lg:pl-16 lg:pr-[31rem] pointer-events-none">
          <h1 className="text-[#f3f705] uppercase font-extrabold text-center sm:text-left tracking-[0.01em] leading-[0.9] text-[13vw] sm:text-[11vw] md:text-[9vw] lg:text-[7vw] drop-shadow-[0_8px_26px_rgba(80,40,0,0.35)]">
            PERS<span className="italic">O</span>NAL AI <span className="italic">O</span>S
          </h1>
        </div>

        <div className="relative min-h-screen z-30 flex items-end justify-center sm:justify-end p-4 sm:p-6 lg:p-8">
          <div className="w-full max-w-md rounded-2xl border border-[#f3f705]/30 bg-[#10161bb3] backdrop-blur-md shadow-[0_30px_60px_-24px_rgba(0,0,0,0.7)] p-5 sm:p-6">
            {isAuthenticated ? (
