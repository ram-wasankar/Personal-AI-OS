...
import { Plus, Search, Clock, MoreHorizontal, StickyNote } from "lucide-react";
    ...
    <div className="h-full flex">
      ...
      <div className="w-72 lg:w-80 border-r border-border/50 flex flex-col shrink-0 bg-surface-0">
        ...
        <div className="flex-1 overflow-y-auto scrollbar-thin px-2 space-y-0.5 pb-4">
          ...
          {isLoading && (
            <p className="px-2 py-2 text-[11px] text-muted-foreground">Loading notes...</p>
          )}
            ...
            return (
              ...
              >
                ...
                <div className="relative z-10">
                  <p className={`text-[13px] font-medium truncate ${isActive ? "text-foreground" : "text-secondary-foreground"}`}>{note.title}</p>
          ...
          <>
            <div className="h-13 flex items-center justify-between px-6 shrink-0 border-b border-border/30">
              <div className="flex items-center gap-2">
                <span className="text-[10px] px-2 py-1 rounded-lg bg-surface-2 text-muted-foreground font-medium">Auto-save on blur</span>
